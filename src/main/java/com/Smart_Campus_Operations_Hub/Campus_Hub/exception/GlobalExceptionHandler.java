...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.Smart_Campus_Operations_Hub.Campus_Hub.resource.ResourceNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> handleResourceNotFound(
            com.Smart_Campus_Operations_Hub.Campus_Hub.resource.ResourceNotFoundException ex,
