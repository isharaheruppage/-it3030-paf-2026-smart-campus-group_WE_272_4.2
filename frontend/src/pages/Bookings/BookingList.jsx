...
import { cancelBooking, deleteBooking, getAllBookings, getBookingsByRequester } from "../../api/bookingApi";
...
function BookingList() {
  ...
  const handleDelete = async (bookingId) => {
    const confirmed = window.confirm("Delete this pending booking permanently?");
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          {currentUser.role === "USER" ? (
            <button
              ...
              className="rounded-full bg-gradient-to-r from-violet-700 to-purple-700 px-4 py-2.5 text-sm font-semibold text-white shadow-[0_16px_30px_rgba(109,40,217,0.24)] transition hover:from-violet-800 hover:to-purple-800"
            >
              Add new booking
            </button>
          ) : null}
      ...
      {editBookingModalOpen && editingBooking ? (
        <div className="fixed inset-0 z-[200] flex items-start justify-center bg-slate-950/35 pt-3 backdrop-blur-xl sm:pt-4 lg:pt-6">
          <div className="relative w-[min(100%-1rem,1200px)] max-w-5xl overflow-hidden rounded-[34px] border border-white/30 bg-gradient-to-br from-white/75 via-white/90 to-violet-50/90 shadow-[0_30px_90px_rgba(76,29,149,0.28)] backdrop-blur-2xl">
            ...
            <div className="max-h-[90vh] overflow-y-auto p-0">
              <BookingForm
                ...
                title="Edit Booking"
                description="Update the pending booking and resubmit it for review."
